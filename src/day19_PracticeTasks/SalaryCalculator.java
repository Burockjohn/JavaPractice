    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            double federalTaxRate = 0.26,
                    groosSalary = hourlyRate * weeklyHour * 52,
                    stateTax = groosSalary * taxRate,
                    federalTax = groosSalary * federalTaxRate,
                    totalTax = stateTax + federalTax,
                    salaryAfterTax = groosSalary - totalTax;

            System.out.println("groosSalary = " + groosSalary);
