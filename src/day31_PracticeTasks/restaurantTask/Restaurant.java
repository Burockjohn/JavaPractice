...
public class Restaurant {
    ...
    public void terminateChef(int IDofEmployee) {
        chefs.removeIf(p -> p.employeeID == IDofEmployee);
    }

    public void terminateServer(int IDofEmployee) {
        servers.removeIf(p -> p.employeeID == IDofEmployee);
    }
...
6.3 Create a class called Restaurant
	            ...
	            Actions: (all void methods)
	                ...
	                whole list of Servers or Chefs.
